			...
			public void onSuccess(Boolean result) {
				...
				if(result==true){
					// существует - продолжить ?
					 ...
					 simple.show();
					 simple.addWindowListener(new WindowListener(){
						@Override
						public void windowHide(WindowEvent we) {
							//System.out.println("ButtonClicked: Item:"+we.getButtonClicked().getId());
							//System.out.println("ButtonClicked: ItemId:"+we.getButtonClicked().getItemId());
							//System.out.println("Buttons: "+simple.getButtons());
							// System.out.println("ButtonBar: "+simple.getButtonBar());
							if(we.getButtonClicked().getItemId().equals("yes")){
								// yes
