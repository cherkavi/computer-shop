...
public class Action implements Serializable{
	...
	/** действие, которое выдает страницу дл€ перенаправлени€ запроса от одной страницы на другую,
	 * предварительно создав данный класс, и вызвав все добавленные методы */
	public Action(Class<? extends Page> pageClass){
		this.pageClass=pageClass;
	}

	/** действие, которое выдает страницу дл€ перенаправлени€ запроса от одной страницы на другую,
	 * предварительно создав данный класс с указанными методами */
	public Action(Class<? extends Page> pageClass, Class<?>[] constructorClasses, Object[] constructorObjects){
		this.pageClass=pageClass;
